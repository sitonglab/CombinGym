...
class GVPMSA(object):
    ...
    def train_onefold(self, fold_idx,epochs=1000,patience=150, save_checkpoint=False, save_prediction=True):
        ...
        for midx, (model, optimizer) in enumerate(zip(self.models, self.optimizers)):
            ...
            #csv_file_path = 'learning_curves.csv'

            # Create a list of tuples containing the epoch, train, val, and test data
            # data = []
            for epoch in range(epochs):
                ...
                #print(epoch, spearman_v_train, spearman_v_val[0], spearman_v_test[0])
                #data.append(epoch, spearman_v_train, spearman_v_val[0], spearman_v_test[0])
            ...
            #with open(csv_file_path, 'w', newline='') as file:
                ...
                #writer.writerow(['Epoch', 'Train', 'Validation', 'Test'])  # Write the header
