...
def main(args):
    ...
    test_dfs = pd.read_csv('input_data/{}/{}_multi.csv'.format(test_dataset,test_dataset)) #测试目标多点
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fold_num', action='store', type=int, default=5, help='number of folds in ensemble')
    ...
    parser.add_argument('--msa_in', action='store',type=str2bool, default=False, help='add msa information into to model')

    parser.add_argument('--epochs', action='store', type=int, default=50, help='maximum epochs')
    parser.add_argument('--patience', action='store', type=int, default=50,help='patience for early stopping')
