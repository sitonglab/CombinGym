...
sys.path.append('/home/Lxc/FLIP/baselines/')
...
def main(args):
    ...
    PATH = Path('/home/Lxc/FLIP/baselines') / "embeddings" / dataset / args.esm_version / split 

    #PATH = "/home/Lxc/FLIP/baselines" / "embeddings" / dataset / args.esm_version / split 
